    ...
    <div class="card shadow  text-white bg-dark">
      ...
      <div class="card-body">
        <div class="btn-group w-100 mb-3" role="group" aria-label="Basic radio toggle button group">
          <input type="radio" class="btn-check" name="btnradio" onclick="getSuggestions()" id="btnradio1" autocomplete="off" checked>
          <label class="btn btn-outline-primary" for="btnradio1" id="get_suggestions_btn">Suggestions ()</label>

          <input type="radio" class="btn-check" name="btnradio"  id="btnradio2" onclick="getRequests('sent')" autocomplete="off">
          ...
          <input type="radio" class="btn-check" name="btnradio" onclick="getConnections()" id="btnradio4" autocomplete="off">
